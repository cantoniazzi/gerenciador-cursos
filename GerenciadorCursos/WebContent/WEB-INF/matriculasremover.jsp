...
<head>
	...
	<title>Cursos de Extensão - Matrícula Remover</title>
...
<body>
	...
	<div id="main" class="container-fluid" style="margin-top: 50px;">
		<h3 class="page-header">Remover Matrícula</h3>
	    <div align="center" class="alert alert-danger" style="text-align:center;">
            Você deseja realmente remover a matrícula do aluno <strong><c:out value="${matricula.getAluno().getNome()}"/> ?</strong>
        </div>	
		<form class="form-horizontal" action="Controller?acao=MatriculaRemover" method="POST">
