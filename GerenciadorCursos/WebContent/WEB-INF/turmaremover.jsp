...
<head>
	...
	<title>Cursos de Extensão - Turma Remover</title>
...
<body>
	...
	<div id="main" class="container-fluid" style="margin-top: 50px;">
		<h3 class="page-header">Remover Turma</h3>
	    <div align="center" class="alert alert-danger" style="text-align:center;">
            Você deseja realmente remover a turma do curso <strong><c:out value="${turma.getCurso().getNome()}"/> ?</strong>
        </div>	
		<form class="form-horizontal" action="Controller?acao=TurmaRemover" method="POST">
