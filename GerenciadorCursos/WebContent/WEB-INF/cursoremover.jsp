...
<body>
	...
	<div id="main" class="container-fluid" style="margin-top: 50px;">
	    ...
	    <div align="center" class="alert alert-danger" style="text-align:center;">
            Você deseja realmente remover o curso <strong><c:out value="${curso.getNome()}"/> ?</strong>
        </div>	
		<form class="form-horizontal" action="Controller?acao=CursoRemover" method="POST">
